...
public:
	...
	const BYTE &GetLTrigger() { return m_GamepadState.bLeftTrigger; }
	const BYTE &GetRTrigger() { return m_GamepadState.bRightTrigger; }
	const SHORT &GetStickLX() { return m_GamepadState.sThumbLX; }
	const SHORT &GetStickLY() { return m_GamepadState.sThumbLY; }
	const SHORT &GetStickRX() { return m_GamepadState.sThumbRX; }
	const SHORT &GetStickRY() { return m_GamepadState.sThumbRY; }
